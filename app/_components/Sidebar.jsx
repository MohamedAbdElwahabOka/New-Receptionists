...
function Sidebar({reg}) {
  ...
  const NewPatientIsActive = searchParams.get('P')=="NewPatient" ? true : false;
  const PatientListIsActive = searchParams.get('P')=="PatientList" ? true : false;
  const ManageAppIsActive = searchParams.get('P')=="ManageApp" ? true : false;
  const MakeAppointmentIsActive = searchParams.get('P')=="MakeApp" ? true : false;
    ...
    const navItems = [
        {
          ...
          ,
          link:`/NewPatient/${reg}?P=NewPatient`,
          text: "New Patient",
          isActive: NewPatientIsActive,
        },
