  ...
  const handleSubmit = (e) => {
    ...
    PostApp.addApp(data).then((res) => {
      ...
      Swal.fire({
        ...
        text: "The patient's appointment has been registered successfully",
        icon: "success"
      });
      ...
      <form >
        ...
        <div className="flex justify-center gap-4 mt-10">
          <button
            ...
            type="submit"
            disabled={!specializations || !hospital || !doctor || !date || !time}
            className={`min-w-[150px] py-3 px-4 text-sm font-semibold rounded text-white bg-blue-500 hover:bg-blue-600 focus:outline-none ${(!specializations || !hospital || !doctor || !date || !time) ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
            Book Appointment
          </button>
        </div>
