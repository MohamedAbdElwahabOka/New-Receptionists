    ...
    <div className="flex h-screen">
        <div className="max-w-4xl mx-auto">
          ...
          <form className="grid grid-cols-2 gap-x-16 gap-y-4">
            <input id="first-name" placeholder="First Name" className="border rounded-md p-2" />
            ...
            <div className="grid grid-cols-3 gap-4 col-span-2">
              <input id="address-governorate" placeholder="Governorate" className="border rounded-md p-2" />
